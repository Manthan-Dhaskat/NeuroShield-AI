...
print("Writing CRITICAL state to trigger intensive CPU workload and memory allocation...")
try:
...
print("CRITICAL severity threat simulation active.")
print("The RASP backend will force shut down the protected app and stop this simulator.")
try:
    while True:
        time.sleep(1)
