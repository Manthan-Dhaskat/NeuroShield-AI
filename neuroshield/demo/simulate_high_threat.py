...
print("Writing HIGH state to trigger high CPU load and memory accumulation...")
try:
...
print("HIGH severity threat simulation active. Press Ctrl+C to terminate and reset.")
try:
    while True:
        time.sleep(1)
